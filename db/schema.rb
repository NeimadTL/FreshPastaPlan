...
ActiveRecord::Schema.define(version: 2018_09_19_190926) do
  ...
  create_table "pastas_packages_relationships", force: :cascade do |t|
    t.integer "pasta_id"
  ...
  create_table "users_subs_relationships", force: :cascade do |t|
    t.integer "user_id"
